...
const CirclePattern = () => (
  <svg className="absolute inset-0 -z-10 h-full w-full stroke-gray-200 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" aria-hidden="true">
    <defs>
      <pattern id="pattern-circles" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse" patternTransform="translate(-10 -10)">
  ...
  const teamMembers = [
    {
      ...
      description: "10+ years in real estate management"
    },
    {
      name: "Michael Chen",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Our platform connects property owners with potential residents, ensuring a smooth and 
                trustworthy experience for both parties. We verify all listings and maintain high 
