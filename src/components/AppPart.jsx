...
const AppDownloadSection = () => {
  return (
    <div className="p-8 flex flex-col md:flex-row items-center justify-between gap-10 w-full">
      ...
      <div className="w-full md:w-1/2 space-y-6">
        <h2 className="text-4xl md:text-5xl font-normal mb-4">Download our App!</h2>
        
        <div className="space-y-2">
          <h3 className="text-3xl md:text-4xl font-normal">Unlock Convenience</h3>
          <p className="text-xl md:text-2xl text-gray-600">Download Our App Today!</p>
        </div>
