  ...
  return (
    <div className="p-8 flex flex-col md:flex-row items-center justify-between gap-12">
      ...
      <div className="w-full md:w-1/2 space-y-8">
        <h2 className="text-5xl font-normal mb-4">Download our App!</h2>
        
        <div className="space-y-4">
          <h3 className="text-4xl font-normal">Unlock Convenience</h3>
          <p className="text-2xl text-gray-600">Download Our App Today!</p>
        </div>
...
>
  ...
  <div className="text-left">
    ...
    <div className="text-xl font-semibold">App Store</div>
          ...
          {/* Play Store Button */}
        <a href="https://play.google.com/store/apps/details?id=com.tech.myperfectpg&pcampaignid=web_share" target="_blank" rel="noopener noreferrer"><button className="flex items-center justify-center gap-3 bg-black text-white px-6 py-3 rounded-xl hover:bg-gray-800 transition-colors">
            <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg">
